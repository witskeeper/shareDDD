...
export const appRouter = [
    ...
    },
    {
        ...
        component: Main,
        children: [
            { path: 'interface-manage', title: '接口管理', name: 'interface-manage', icon: 'link', component: resolve => { require(['@/views/interface/interface-manage.vue'], resolve); } },
            { path: 'project-document', title: '项目文档', name: 'project-document', icon: 'android-send', component: resolve => { require(['@/views/interface/project-document.vue'], resolve); } }
        ]
    },
    {
        path: '/testcacse',
