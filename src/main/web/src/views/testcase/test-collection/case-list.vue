    ...
    export default {
        ...
        methods: {
            ...
            addInterface(index){
                ...
                this.$router.push({path:"/testcase/test-collection/case-edit",query:{interfaceId:""}})
            },
            onRowClick(rowData,index){
                console.log(rowData)
                this.$router.push({path:"/testcase/test-collection/case-edit",query:{interfaceId:rowData.id}})
            },
        }
    }
</script>
